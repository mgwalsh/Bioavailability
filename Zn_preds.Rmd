...
While these predictions are clearly offset. We could adjust for the offset by debiasing, but that does not alter the notion that soil properties via various lab tests, do indeed appear to be linked to Zn concentrations in maize grain in Malawi. See the example chunk below for debiasing.  
