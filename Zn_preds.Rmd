...
While these predictions are clearly offset, we could adjust for that by debiasing. That does not alter the notion that soil properties via various lab tests, do indeed appear to be quite predictive for maize grain Zn levels in Malawi. See the short example chunk below for debiasing.  
