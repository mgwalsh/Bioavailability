...
The predictions are clearly offset, but we can adjust for that. Note that this does not alter the notion that the wet chemistry soil properties do indeed appear to be quite useful for predicting maize grain Zn levels in Malawi, plus or minus some outlier noise. The next short chunk adjusts for the 50% quantile (median) offset that is used to generate the associated figure below.  
