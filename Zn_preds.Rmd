...
The predictions are clearly offset, but we can adjust for that by debiasing the `quantreg` fits. That does not alter the notion that soil properties via various lab tests do indeed appear to be quite useful for predicting maize grain Zn levels in Malawi. See the short example chunk for debiasing and figure below.  
