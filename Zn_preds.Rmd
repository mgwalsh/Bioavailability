...
```{r, echo = FALSE, fig.align = "center", fig.cap = "Relationship between median adjusted spectral predictions and measured maize grain zinc (Zn) levels."}
...
We can compare how the spectral predictions perform relative to the much more expensive and time consuming wet chemistry based predictions. The figure below shows that relationship.
