...
The predictions are clearly offset, but we can adjust for that. This does not alter the notion that wet chemistry soil properties do indeed appear to be quite useful for predicting maize grain Zn levels in Malawi. See the short example chunk for offset adjustment and the associated figure below.  
...
```{r, echo = FALSE, fig.align = "center", fig.cap = "Relationship between adjusted predictions (based on soil wet chemistry properties) and measured maize grain zinc (Zn) levels."}
