...
This is the `slist` prediction plot below. Note that the intermediate steps are not shown in this html; however, they are in the script should you wish to check.
...
```{r, echo = FALSE, fig.align = "center", fig.cap = "Relationship between predicted (based on soil soil spectral properties) and measured maize grain zinc (Zn) levels. The blue lines are the 5% and 95% quantile regression estimates. The red line is the regression at the median,"}
