...
```{r, echo = FALSE, fig.align = "center", fig.cap = "Relationship between median debiased predictions (based on soil wet chemistry properties) and measured maize grain zinc (Zn) levels."}
