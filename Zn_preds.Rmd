...
```{r, fig.align = "center", fig.cap = "Relationship between predicted and measured maize grain zinc (Zn) levels."}

par(pty="s", mar=c(4,4,1,1))
plot(Zn~sw, xlab="Ensemble Zn prediction (mg/kg)", ylab="Measured grain Zn (mg/kg)", cex.lab=1.2, 
