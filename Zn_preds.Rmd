...
```{r, echo = FALSE, fig.align = "center", fig.cap = "Relationship between median adjusted predictions from soil data and measured maize grain zinc (Zn) levels."}
...
```{r, echo = FALSE, fig.align = "center", fig.cap = "Relationship between median offset adjusted spectral predictions and measured maize grain zinc (Zn) levels."}
...
cpcas <- cpcas[ ,1:25] ## save the first 25 components, which explain ~95% of the total crop spectral variability
...
So, skipping ahead to the results of the script the below shows the relationship between Zn predictions generated from maize grain MIR spectra and the corresponding reference measurements.
