...
We initially fit 3 calibration MLAs to the soil spectral principal components data with 10-fold cross-validation. Note that the calibration code pattern is similar to the wet-chemistry-based pattern that was generated above. We just substitute the soil spectral principal components for the wet chemistry features but are running the same MLAs for comparison.
